  ...
  vueCustomGridFilter: null,
	...
	initComponents: function () {
		BizappComponents.vueCustomTree = Vue.extend({
			template: `<div><div class="navigation-filter">
      ...
      <div class="navigation-tree" v-if="!_.isEmpty(treeData)" style="height: 300px;overflow: auto;width: 100%;border-top: 1px solid #ccc;border-bottom: 1px solid rgb(204, 204, 204);">
      ...
      <div class="col-md-6"><a style="float:right" class="btn btn-secondary" role="button" @click="onCompleteSrc(true)">Cancel</a></div>
